"""Centralized logging configuration for semantic_matcher.
...
def configure_logging(
    ...
    """Configure logging for semantic_matcher package.

    This function sets up the root logger for the semantic_matcher package
    ...
    Example:
        >>> from semanticmatcher.utils.logging_config import configure_logging
    ...
    # Get the semantic_matcher root logger
...
def suppress_third_party_loggers() -> None:
    ...
    Example:
        >>> from semanticmatcher.utils.logging_config import suppress_third_party_loggers
        >>> suppress_third_party_loggers()
    """
...
def get_logger(name: str) -> logging.Logger:
    ...
    for the semantic_matcher package. Use this instead of logging.getLogger()
    ...
    """
    if name == "semanticmatcher" or name.startswith("semanticmatcher."):
        return logging.getLogger(name)
    return logging.getLogger(f"semanticmatcher.{name}")
...
def set_log_level(level: int) -> None:
    ...
    Example:
        >>> from semanticmatcher.utils.logging_config import set_log_level, DEBUG
